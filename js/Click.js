    ...
    tabFormat: {
        "Clicky": {
            content: [
                ...
                ["display-text",
                    function(){
                        let txt = "You are getting "+new Decimal(player.Mi.clicky.add(player.Mi.clickyadd).times(player.Mi.clickymult).times(getBuyableAmount("Mi", 11).add(1).times(player.Mi.buyableboost)).floor())+" per click"
                        return txt
                    }
                ],
                "blank", 
