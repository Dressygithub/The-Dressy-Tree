let modInfo = {
	...
	author: "Dressyapper",
	pointsName: "Points",
	modFiles: ["DressyLayer.js", "tree.js", "components.js","achievements.js","testinggrounds.js"],
...
function getPointGen() {
	...
	if (hasUpgrade('T', 15)) gain = gain.pow(gain.pow(gain.pow(gain.pow(gain.pow(gain.pow(gain.pow(gain.pow(gain.pow(gain.pow(gain.pow(gain.pow(gain.pow(gain.pow(gain.pow(gain.pow(player.points))))))))))))))))
